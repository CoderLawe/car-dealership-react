...
function CardSection() {
  ...
  return (
    <div className="shadow-lg pb-[30px] rounded-[2px] mx-[60px] block  mt-[80px] overflow-x-scroll ">
        
        {/* Top title */}
        <p className="text-[#24272C] text-[23px] font-[500] mt-[20px] ml-[24px]">The most searched cars</p>


        {/* Car cards (replace images later) */}

        <div className="flex space-x-[20px] mt-[10.5px] mx-[24px]">

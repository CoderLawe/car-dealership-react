...
function CarCardMain({type, title, image, price, fuel, mileage, transmission }) {
  return (
    <div className="block">
        <div className="relative">
            
            <img className="h-[218.08px] w-[332.66px] object-cover" src={image}/>
        ...
        <div className="block">
            ...
            <p className="text-[16px] font-[700] text-[#262626] mt-[15px]">{title}</p>
            ...
            <button className=" h-[40px] w-full text-[#F75D34] bg-white border border-[#F75D34] text-[12px] mt-[16px] cursor-pointer hover:bg-[#F75D34] hover:text-gray-100 transform transition-all duration-300 ease-out">More Details</button>
